...
class ComprobanteService {
    ...
    private GenerarDatosComunes(pedido:Pedido, papel:string): ObjComprobante {
        ...
        comprobante.fechaPedido = fecha.toLocaleDateString('es-ES', {
            day: '2-digit', month: '2-digit', year: '2-digit'
        });
                    ...
                    stack: [
                      ...
                      },
                      {
                        text: [
                          ...
                          { text: comprobante.fechaPedido + ' - ' + comprobante.horaPedido }
                        ],
                        style: 'simple'
                      },
                      {
